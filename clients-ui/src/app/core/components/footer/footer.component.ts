...
@Component({
  ...
  template: `
    <footer
      class="mt-auto border-t border-[var(--color-border)]"
      style="background: var(--color-bg-secondary)"
    >
      <!-- Aurora gradient line -->
      <div
        class="h-[2px] bg-gradient-to-r from-[var(--color-brand-secondary)] via-[var(--color-brand-accent)] to-[var(--color-brand-primary)]"
      ></div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="space-y-3">
            ...
            >
              Desenvolvedor Full-Stack | Projetos com IA Integrada (RAG,
          ...
          <div class="space-y-3">
            ...
            <div class="space-y-2.5">
              ...
              >
                <svg
                  class="w-4 h-4 transition-colors group-hover:text-[var(--color-text-primary)]"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  aria-hidden="true"
                >
                ...
                <span class="group-hover:text-[var(--color-text-primary)]"
                  >devviniuchita</span
                >
              </a>
              ...
              >
                <svg
                  class="w-4 h-4 transition-colors group-hover:text-[#0A66C2]"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  aria-hidden="true"
                >
              ...
              >
                <svg
                  class="w-4 h-4 transition-colors group-hover:text-[var(--color-brand-accent)]"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="2"
                ...
                <span class="group-hover:text-[var(--color-brand-accent)]"
                  >viniciusuchita&#64;gmail.com</span
                >
              </a>
            </div>
          </div>
          ...
          <div class="space-y-3">
            ...
            <a
              href="https://github.com/devviniuchita/clients_api"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              ...
              <svg
                class="w-3.5 h-3.5 ml-auto flex-shrink-0 transition-transform group-hover:translate-x-0.5"
                style="color: var(--color-text-muted)"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
            ...
            <div
              class="flex items-center gap-4 text-[10px] font-mono pt-1"
              style="color: var(--color-text-muted)"
            >
              ...
              <span class="flex items-center gap-1">
                <span class="w-2 h-2 rounded-full bg-[#3178C6]"></span>
                TypeScript
              </span>
              <span class="flex items-center gap-1">
        ...
        <!-- Bottom bar -->
        <div
          class="mt-8 pt-4 border-t border-[var(--color-border)] flex flex-col sm:flex-row items-center justify-between gap-2"
        >
